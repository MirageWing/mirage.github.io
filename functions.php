...
if ( ! defined( 'EYEPRESS_VERSION' ) ) {
	// Replace the version number of the theme on each release.
	define( 'EYEPRESS_VERSION', '1.2.4' );
}
...
function eyepress_scripts() {
	...
	wp_enqueue_style( 'eyepress-default', get_template_directory_uri() .'/assets/css/eyepress-default.css', array(),EYEPRESS_VERSION,'all' );
	wp_enqueue_style( 'eyepress-style', get_stylesheet_uri() );
	wp_enqueue_style( 'eyepress-responsive', get_template_directory_uri() .'/assets/css/responsive.css', array('eyepress-style'),EYEPRESS_VERSION,'all' );
	...
	wp_enqueue_script( 'eyepress-main-js', get_template_directory_uri() .'/assets/js/main.js', array('jquery'), EYEPRESS_VERSION, true );
	if($eyepress_grid_type == 'mesonry'){
	wp_enqueue_script('masonry');
	wp_enqueue_script( 'eyepress-masonry-active', get_template_directory_uri() .'/assets/js/masonry-active.js', array('jquery'), EYEPRESS_VERSION, true );
	}
